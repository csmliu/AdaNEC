...
def str2bool(x):
    if x.lower() in ('y', 't', '1', 'yes', 'true'):
        return True
    elif x.lower() in ('n', 'f', '0', 'no', 'false'):
        return False
    else:
        raise ValueError('The given parameter [%s] is invalid'%x)
...
class BaseOptions():
    ...
    def initialize(self):
        ...
        # for AdaNEC
        self.parser.add_argument('--nModel', type=int, default=1)
        self.parser.add_argument('--avg', type=float, default=[0.108686739, 0.009344623, 0.881968638], nargs='+', help='real20')
        # self.parser.add_argument('--avg', type=float, default=[0.217511492, 0.111057787, 0.671430722], nargs='+', help='wild')
        # self.parser.add_argument('--avg', type=float, default=[0.101291473, 0.580948268, 0.317760259], nargs='+', help='postcard')
        # self.parser.add_argument('--avg', type=float, default=[0.186080102, 0.355502779, 0.458417119], nargs='+', help='solid')
        # self.parser.add_argument('--avg', type=float, default=[0.190290713, 0.423943493, 0.385765795], nargs='+', help='nature20')
        self.parser.add_argument('--show_expertise_level', type=str2bool, default=False)
